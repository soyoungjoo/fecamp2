// var는 변수를 선언할 때 사용하는 키워드(varible)
...
var num = 100.5;
var boo = true; //불리언(Bollean). true 또는 false만 가질 수 있다.

var str2 = str; // str값을 str2에 복사
str = '문자열을 막 바꿔'; // var는 변수를 처음 만들 떄만 사용한다.
...
var 숫자인가문자열인가 = 숫자삼백 + '';
console.log(typeof 숫자인가문자열인가); // "string"
